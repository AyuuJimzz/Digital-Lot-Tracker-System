...
## Overview
This system allows updating lot statuses and automatically sends reminder emails to customers when lots have been pending for more than 1 hour.
...
- **Triggers**: Sends emails to customers for lots pending > 1 hour
